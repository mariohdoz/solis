      ...
      <!-- término se container -->
            ...
            <h3 class="box-title">Datos del cliente</h3>
					...
					<div class="box-footer">
						...
						<?php echo CHtml::link('Actualizar cliente', array('/cliente/update/', 'id'=>$model->rut_cliente), array('class'=>'btn btn-info', 'confirm' => '¿Está seguro de actualizar el cliente?')); ?>
						<?php echo CHtml::link("Eliminar cliente", '#', array(
								'submit'=>array('/arriendo/delete', "id"=>$model->rut_cliente),
