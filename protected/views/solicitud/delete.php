    ...
    <div class="row">
      <div class="col-md-12">
        <div class="callout callout-danger">
          <h4>Está a punto de eliminar Solicitud n° <?php echo  CHtml::encode($solicitud->id_solicitud); ?>!</h4>
          <p>Si elimina la solicitud no se podrá tener acceso a ella nunca más.</p>
        </div>
      </div>
      <!-- Inicio se container -->
      <div class="col-md-12">
